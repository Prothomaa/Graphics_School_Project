...
void table(unsigned int& cubeVAO, Shader& lightingShader, glm::mat4 als)
{
    ...
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(1.0f, .2f, 0.5f));
    model = als * translateMatrix * scaleMatrix;
    drawCube(cubeVAO, lightingShader, model, 0.0, 0.8078f, .8196f);
    ...
    */
    ...
    //Sofa leg1
    translateMatrix = glm::translate(identityMatrix, glm::vec3(0.05, 0.3 + 0.5 * 0.2, -0.9));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(0.025f, -1.0f, 0.05f));
    model = als * translateMatrix * scaleMatrix;
    drawCube(cubeVAO, lightingShader, model, 0.0, 0.5019f, 0.5019f);
    ...
    //Sofa leg2
    translateMatrix = glm::translate(identityMatrix, glm::vec3(1.0 + 0.025 , 0.3 + 0.5 * 0.2, -0.9));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(0.025f, -1.0f, 0.05f));
    model = als * translateMatrix * scaleMatrix;
    drawCube(cubeVAO, lightingShader, model, 0.0, 0.5019f, 0.5019f);

    //Sofa leg4
    translateMatrix = glm::translate(identityMatrix, glm::vec3(1.0 + 0.025, 0.3 + 0.5 * 0.2, -0.9 + 0.5 - 0.05));
    scaleMatrix = glm::scale(identityMatrix, glm::vec3(0.025f, -1.0f, 0.05f));
    model = als * translateMatrix * scaleMatrix;
    drawCube(cubeVAO, lightingShader, model, 0.0, 0.5019f, 0.5019f);
}
